...
✅ 문제 해결
  - Object의 장점을 활용하면서도 객체의 생성순서를 보장하는 Map 자료구조 활용

<br />

#### 1.4 구현 결과 : 빠른 데이터 조회와 시간의 순서 보장 

> Object는 생성된 순서를 보장하는 Map 데이터 반복 렌더링
...
1. **드래그동작 구현을 위해서 여러가지 이벤트를 조합하기**
  - 드래그 기능 구현을 위해서 여러가지 이벤트를 조합해야 했습니다.
    > 드래그란 사용자가 마우스를 클릭한 상태로 움직였다가 떼는 과정입니다.
    > 
    > 즉, 사용자의 동작에 따라 적절하게 UI가 바뀌어야 함을 의미합니다.
  #### 어떤 이벤트를 조합하는게 좋을까?
